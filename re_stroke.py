...
HCY = col2.number_input('HCY (μmol/L)',value=15.7)
Anticoagulation = col3.selectbox("Anticoagulation",('No','Yes'))
...
features = ['SOH', 'HCY',  'Anticoagulation', 'SS']
target = 'Status'
...
sp = 0.5
#figure
is_t = (XGB.predict_proba(np.array([[SOH, HCY,  Anticoagulation, SS]]))[0][1])> sp
prob = (XGB.predict_proba(np.array([[SOH, HCY,  Anticoagulation, SS]]))[0][1])*1000//1/10
